...
import com.onk.grp2.Environment.autoGenerated.EnvironmentDataReader;
import com.onk.grp2.Environment.autoGenerated.EnvironmentSeq;
import com.onk.grp2.Environment.autoGenerated.EnvironmentTypeSupport;
		...
		public void on_data_available(DataReader reader) {
			...
			try {
				...
				for (int i = 0; i < dataSeq.size(); i++) {
					...
					if (info.valid_data) {
						System.out.println(((Environment) dataSeq.get(i)).toString("Received", 0));
					}
