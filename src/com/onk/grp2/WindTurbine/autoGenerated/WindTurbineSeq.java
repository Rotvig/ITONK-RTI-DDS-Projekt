...
/**
 * A sequence of WindTurbine instances.
 */
public final class WindTurbineSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public WindTurbineSeq() {
        super(WindTurbine.class);
    }


    public WindTurbineSeq(int initialMaximum) {
        super(WindTurbine.class, initialMaximum);
    }


    public WindTurbineSeq(Collection elements) {
        super(WindTurbine.class, elements);
    }
