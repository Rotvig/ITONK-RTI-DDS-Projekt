 ...
 * Environment.
 */
public class EnvironmentTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------
    ...
    private static final EnvironmentTypeSupport _singleton
        = new EnvironmentTypeSupport();
     ...
     */
    public static EnvironmentTypeSupport get_instance() {
        return _singleton;
    }

    public static EnvironmentTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>Environment</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        Environment typedDst = (Environment) destination;
        Environment typedSrc = (Environment) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        Environment typedSrc = (Environment) sample;
...
Environment typedDst = (Environment) dst;
...
Environment typedDst = (Environment) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
Environment typedDst = (Environment) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new EnvironmentDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new EnvironmentDataReader(native_reader, listener, mask, this);                
    ...
    protected EnvironmentTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,EnvironmentTypeCode.VALUE,Environment.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected EnvironmentTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,EnvironmentTypeCode.VALUE,Environment.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
