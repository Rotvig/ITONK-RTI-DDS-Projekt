...
public enum EnvironmentSubscriber implements Closeable {
	...
	public void Initialize(String topicName, int domainId, EnvironmentReceiver environmentReceiver) {
		if (!initialized) {
			if(environmentReceiver == null) {
				throw new IllegalArgumentException("Specify a valid EnvironmentReceiver");
			}
