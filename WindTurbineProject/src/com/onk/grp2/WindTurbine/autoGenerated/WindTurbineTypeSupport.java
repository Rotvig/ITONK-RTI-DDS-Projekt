 ...
 * WindTurbine.
 */
public class WindTurbineTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "WindTurbine";
    ...
    private static final WindTurbineTypeSupport _singleton
        = new WindTurbineTypeSupport();
     ...
     */
    public static WindTurbineTypeSupport get_instance() {
        return _singleton;
    }

    public static WindTurbineTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return WindTurbine.create();
    }
     ...
     * <code>this</code> is not a <code>WindTurbine</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        WindTurbine typedDst = (WindTurbine) destination;
        WindTurbine typedSrc = (WindTurbine) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        WindTurbine typedSrc = (WindTurbine) sample;
...
WindTurbine typedSrc = (WindTurbine) src;    
        ...
        dst.writeFloat(typedSrc.orientation);        
            
        dst.writeFloat(typedSrc.bladePitch);        
            
        dst.writeFloat(typedSrc.RPM);        
            
        dst.writeFloat(typedSrc.temperature);        
            
        dst.writeFloat(typedSrc.production);        
...
WindTurbine typedDst = (WindTurbine) dst;
    ...
    try {
            ...
            typedDst.orientation = src.readFloat();
            
            typedDst.bladePitch = src.readFloat();
            
            typedDst.RPM = src.readFloat();
            
            typedDst.temperature = src.readFloat();
            
            typedDst.production = src.readFloat();
...
WindTurbine typedDst = (WindTurbine) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
WindTurbine typedDst = (WindTurbine) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new WindTurbineDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new WindTurbineDataReader(native_reader, listener, mask, this);                
    ...
    protected WindTurbineTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,WindTurbineTypeCode.VALUE,WindTurbine.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected WindTurbineTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,WindTurbineTypeCode.VALUE,WindTurbine.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
